    ...
    <li className="max-w-sm bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
      ...
      <div className="p-5">
        ...
        <div className="flex items-center justify-between">
          ...
          <button className="text-white bg-primary hover:bg-primary3 focus:ring-0 focus:outline-none focus:ring-blue-300 font-medium rounded-full text-sm px-5 py-2.5 text-center  dark:hover:bg-primary dark:focus:ring-0">
            Add To Cart
          </button>
        </div>
      </div>
