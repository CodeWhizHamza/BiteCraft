        ...
        <div className="w-full max-w-7xl px-4 md:px-5 lg-6 mx-auto">
          ...
          <div className="rounded-3xl border-2 border-gray-200 p-4 lg:p-8 grid grid-cols-12 mb-8 max-lg:max-w-lg max-lg:mx-auto gap-y-4">
            ...
            <div className="col-span-12 lg:col-span-10 detail w-full lg:pl-3">
              ...
              <div className="flex justify-between items-center">
                ...
                <h6 className="text-primary2 font-manrope font-bold text-2xl leading-9 text-right">
                  $220
                </h6>
              </div>
            </div>
          ...
          <div className="flex flex-col md:flex-row items-center md:items-center justify-between lg:px-6 pb-6 border-b border-gray-200 max-lg:max-w-lg max-lg:mx-auto">
            ...
            <div className="flex items-center justify-between gap-5 ">
              <button className="rounded-full py-2.5 px-3 bg-indigo-50 text-primary2 font-semibold text-xs text-center whitespace-nowrap transition-all duration-500 hover:bg-indigo-100">
                Promo Code?
              </button>
              <h6 className="font-manrope font-bold text-3xl lead-10 text-primary2">
                $440
              </h6>
            </div>
          </div>
